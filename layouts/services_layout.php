...
<section id="<?php echo $id; ?>" class="<?php echo $id; ?> layer  <?php echo $xclass; ?> ">
	...
	<?php if (get_sub_field("content")) { ?>
		<div class="clearfix inner">
			<div class="inner inner-wider col">
				<div class="<?php if (get_sub_field('content_sidebar')) {
								echo 'col-7';
							} ?>sub-title">
					...
					<div class="services alternating">
						...
						?>
								<article id="<?php echo $post->post_name; ?>">
									<div class="altern grid <?php if ($count % 2 == 0) {
																echo 'grid-reverse';
															} ?> page-<?php echo get_the_ID() . '  ' . get_field('page_class'); ?>">
